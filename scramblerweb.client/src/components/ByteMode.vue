<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <input type="text" v-model="key" placeholder="Введіть ключ у HEX форматі">
      <button>Згенерувати</button>
    </div>
    <div class="textarea-container">
      <textarea id="inputData" placeholder="Вхідні дані"></textarea>
      <div class="buttons">
        <button id="encryptBtn">Заскремблювати</button>
        <button id="decryptBtn">Розскремблювати</button>
      </div>
      <textarea id="outputData" placeholder="Вихідні дані"></textarea>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        key: "",
        algorithms: [
          { name: "algo1", label: "Алгоритм 1", color: "#ff9999" },
          { name: "algo2", label: "Алгоритм 2", color: "#99ccff" },
          { name: "algo3", label: "Алгоритм 3", color: "#99ff99" },
          { name: "algo4", label: "Алгоритм 4", color: "#ffcc99" },
        ],
        selectedAlgorithms: [],
        dragIndex: null,
      };
